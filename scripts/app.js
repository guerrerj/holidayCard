...
@Modified by Jose Guerrero

@Credits 
James Rogers - thank you for most of the work :->
@Author https://riptutorial.com/three-js/example/17088/object-picking---raycasting For the raycaster setup (Refactored by myself)
...
function init() {
    ...
    fontLoader.load( '../assets/scene/medusafont.js', function ( font ) {
        ...
        let textGeo = new THREE.TextGeometry( `Merry Christmas and may God bless you in the new year.`, {
